...
$PROJECT_REF = "aoscqszairjhngugjjtn"
...
foreach ($stmt in $statements) {
    $label = $stmt.Trim().Substring(0, [Math]::Min(70, $stmt.Trim().Length)).Replace("`n"," ").Replace("`r","")
...
Write-Host "`n=== Schema Apply Complete: $successCount OK, $errorCount Failed ===" -ForegroundColor Cyan
